    ...
    <main className="min-h-screen bg-background">
      <div className="section-container">
        ...
        <section className="py-16">
          ...
          {isLoading ? (
            <div className="mt-10 rounded-xl border border-border bg-card p-8 text-center text-muted-foreground">Cargando publicaciones...</div>
          ) : posts.length > 0 ? (
            ...
            <div className="mt-10 flex min-h-[320px] items-center justify-center rounded-xl border border-dashed border-border bg-card/70 p-8 text-center">
              <div className="max-w-md">
                ...
                <Link href="/" className="mt-6 inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-bold text-primary-foreground transition hover:bg-primary/90">
                  Volver a Dyxersoft
                </Link>
              </div>
            </div>
